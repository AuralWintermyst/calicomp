...
namespace Calicomp
{
    public partial class EmpShiftView : System.Web.UI.Page
    {
        ...
        protected void request_Click(object sender, EventArgs e)
        {
            ...
            string msg = "Request " + shift + " at" + date + " from " + start + " to " + end;
            int id = int.Parse(get_id);
            ...
            using (var message = new MailMessage("tempgarbo@gmail.com", recepient))
            {
                ...
                message.Body = firstName.Text + " has requested for " + shift + " at " + date + " from " + start + " to " + end;
